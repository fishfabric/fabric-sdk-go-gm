...
FABRIC_TOOLS_VERSION ?= $(FABRIC_PREV_VERSION)

# Fabric tools docker image (overridable)
FABRIC_TOOLS_IMAGE ?= hyperledger/fabric-tools-gm
...
lint: version populate-noforce lint-submodules
	@MODULE="github.com/tw-bc-group/fabric-sdk-go-gm" PKG_ROOT="./pkg" LINT_CHANGED_ONLY=true GOLANGCI_LINT_VER=$(GOLANGCI_LINT_VER) $(TEST_SCRIPTS_PATH)/check_lint.sh

.PHONY: lint-submodules
lint-submodules: version populate-noforce
	@MODULE="github.com/tw-bc-group/fabric-sdk-go-gm/test/integration" LINT_CHANGED_ONLY=true GOLANGCI_LINT_VER=$(GOLANGCI_LINT_VER) $(TEST_SCRIPTS_PATH)/check_lint.sh
	@MODULE="github.com/tw-bc-group/fabric-sdk-go-gm/test/performance" LINT_CHANGED_ONLY=true GOLANGCI_LINT_VER=$(GOLANGCI_LINT_VER) $(TEST_SCRIPTS_PATH)/check_lint.sh

.PHONY: lint-all
lint-all: version populate-noforce
	@MODULE="github.com/tw-bc-group/fabric-sdk-go-gm" PKG_ROOT="./pkg" GOLANGCI_LINT_VER=$(GOLANGCI_LINT_VER) $(TEST_SCRIPTS_PATH)/check_lint.sh
	@MODULE="github.com/tw-bc-group/fabric-sdk-go-gm/test/integration" GOLANGCI_LINT_VER=$(GOLANGCI_LINT_VER) $(TEST_SCRIPTS_PATH)/check_lint.sh
	@MODULE="github.com/tw-bc-group/fabric-sdk-go-gm/test/performance" GOLANGCI_LINT_VER=$(GOLANGCI_LINT_VER) $(TEST_SCRIPTS_PATH)/check_lint.sh
